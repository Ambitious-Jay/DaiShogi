...
struct ferociousLeopard: Piece {
    ...
    var pieceName: String = "猛豹"
    var pieceID: pieceTypes = .ferociousLeopard
    var promotesTo: Piece? {
        bishop(isPromoted: true, isWhite: self.isWhite)
    }
